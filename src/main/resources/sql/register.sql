...
CREATE TABLE `doctor`  (
  ...
  `num` int(11) NULL DEFAULT NULL COMMENT '-1不限制 其他限制',
...
CREATE TABLE `registration`  (
  ...
  `finish` int(255) NULL DEFAULT NULL COMMENT '0 未结束，1 结束',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user`  (
  ...
  `type` int(255) NULL DEFAULT NULL COMMENT '0管理员 1医生 2挂号',
  `doctorId` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
